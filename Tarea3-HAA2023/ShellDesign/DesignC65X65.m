...
Mu_ = [intLoads(:, 6); intLoads(:, 5)];
Pu_ = [intLoads(:,1); intLoads(:,1)];
Vu_ = [intLoads(:,3); intLoads(:,2)];
...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% %%%%%%%%%%%%%% VOY A CREAR UNA FUNCIÓN PARA EXTRAER EL VU DE DISEÑO QUE
% %%%%%%%%%%%%%% DEBE SER EL MÁXIMO VU DE CUALQUIER COLUMNA
% %%%%%% getAllVu() --> Retornar Vector co max([V2(:); V3(:)] 
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Vu_design = 3.07; % tonf
% Vsismico = 0.797; %tonf
% fprintf('Vu = %.2f [tonf]\n', Vu_design)
